/*
 ...
 Date: 03/22/2017 17:02:20 PM
*/

-- ----------------------------
--  Sequence structure for documentRelationships_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "documentRelationships_id_seq";
...
CREATE SEQUENCE "object_id_seq" INCREMENT 1 START 581 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;

-- ----------------------------
--  Sequence structure for transactionRecord_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "transactionRecord_id_seq";
CREATE SEQUENCE "transactionRecord_id_seq" INCREMENT 1 START 942 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;

-- ----------------------------
--  Sequence structure for transactionType_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "transactionType_id_seq";
...
-- ----------------------------
DROP TABLE IF EXISTS "googleDriveBackups";
...
INSERT INTO "keyword" VALUES ('580');
COMMIT;
...
-- ----------------------------
DROP TABLE IF EXISTS "documentRelationships";
...
INSERT INTO "usuario" VALUES ('215', 'root0', 't', 't', '123', 't');
COMMIT;
...
INSERT INTO "object" VALUES ('578', 'Documento', 'Brulots', '2017-03-21 16:48:37.031487', '137', '', 'document');
INSERT INTO "object" VALUES ('580', 'mapas', null, '2017-03-22 11:55:57.918216', '124', '', 'keyword');
INSERT INTO "object" VALUES ('581', 'cc', 'cc', '2017-03-22 12:35:06.207621', '124', '', 'document');
COMMIT;
...
INSERT INTO "document" VALUES ('578', '05 BruÌlots.mp3', '2017-03-20', '128', 'f', 'f', 'f');
INSERT INTO "document" VALUES ('581', '19 de septiembre de 16 IMPORTANCIA DE LOS MAPAS.docx', '2017-03-22', '127', 'f', 'f', 'f');
...
INSERT INTO "transactionRecord" VALUES ('941', '2017-03-22 11:55:58.087103', '580', '124', '5');
INSERT INTO "transactionRecord" VALUES ('942', '2017-03-22 12:35:06.2442', '581', '124', '3');
COMMIT;

-- ----------------------------
--  Table structure for areaRelationships
-- ----------------------------
DROP TABLE IF EXISTS "areaRelationships";
...
-- ----------------------------
DROP TABLE IF EXISTS "documentKeywordRelationship";
...
ALTER SEQUENCE "object_id_seq" RESTART 582 OWNED BY "object"."id";
ALTER SEQUENCE "transactionRecord_id_seq" RESTART 943 OWNED BY "transactionRecord"."id";
