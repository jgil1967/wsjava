  app.controller('moveDocumentDialogController',['$scope','$http','$timeout', '$q','documentosService','$mdDialog', 
      function($scope,$http,$timeout, $q,documentosService,$mdDialog) {
            ...
            return documentosService.getDocumentMove();
        }, function (document) {
            
            
            if (document!=0){
                 $mdDialog.show({
                                controller: moveDocumentController,
                                controllerAs: 'ctrl',
                                templateUrl: 'moverDocumento.tmpl.html',
    ...
    function click(d) {
        ...
        if (confirm('¿Esta seguro de que desea mover este archivo de carpeta?')) {
          window.console.log(d);
                    ...
                    documentos.push(documentoDestino);
                    
 documentosService.moveDocuments(documentos).then(function(d) {
